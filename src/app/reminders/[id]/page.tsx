...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 px-4 py-4 pb-10 z-50">
        <div className="flex items-center justify-between w-full bg-white mx-auto fixed top-0">
          <BackButton />
